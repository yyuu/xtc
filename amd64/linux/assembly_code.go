...
type AssemblyCode struct {
  ...
  virtualStack *amd64.VirtualStack
...
func NewAssemblyCode(naturalType int, labelSymbols *xtc_asm.SymbolTable) *AssemblyCode {
  return &AssemblyCode {
    ...
    virtualStack: amd64.NewVirtualStack(naturalType),
    Assemblies: []xtc_core.IAssembly { },
...
func (self *AssemblyCode) doesUses(reg *amd64.Register) bool {
...
func (self *AssemblyCode) virtualPush(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.virtualStack.Extend(STACK_WORD_SIZE)
  self.mov3(reg, self.virtualStack.Top())
}

func (self *AssemblyCode) virtualPop(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
...
func (self *AssemblyCode) cmp(a xtc_core.IOperand, b *amd64.Register) {
  if a == nil { panic("a is nil") }
  if b == nil { panic("b is nil") }
  self.insn6(b.GetTypeId(), "cmp", a, b)
}

func (self *AssemblyCode) sete(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("sete", reg)
}

func (self *AssemblyCode) setne(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("setne", reg)
}

func (self *AssemblyCode) seta(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("seta", reg)
}

func (self *AssemblyCode) setae(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("setae", reg)
}

func (self *AssemblyCode) setb(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("setb", reg)
}

func (self *AssemblyCode) setbe(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("setbe", reg)
}

func (self *AssemblyCode) setg(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("setg", reg)
}

func (self *AssemblyCode) setge(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("setge", reg)
}

func (self *AssemblyCode) setl(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("setl", reg)
}

func (self *AssemblyCode) setle(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn2("setle", reg)
}

func (self *AssemblyCode) test(a *amd64.Register, b *amd64.Register) {
  if a == nil { panic("a is nil") }
  if b == nil { panic("b is nil") }
  self.insn6(b.GetTypeId(), "test", a, b)
}

func (self *AssemblyCode) push(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn3("push", self.typeSuffix(self.NaturalType), reg)
}

func (self *AssemblyCode) pop(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
...
func (self *AssemblyCode) callAbsolute(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
...
func (self *AssemblyCode) mov1(src *amd64.Register, dest *amd64.Register) {
...
// load
func (self *AssemblyCode) mov2(src xtc_core.IOperand, dest *amd64.Register) {
  if src == nil { panic("src is nil") }
  if dest == nil { panic("dest is nil") }
...
// save
func (self *AssemblyCode) mov3(src *amd64.Register, dest xtc_core.IOperand) {
  if src == nil { panic("src is nil") }
  if dest == nil { panic("dest is nil") }
...
func (self *AssemblyCode) movsx(src *amd64.Register, dest *amd64.Register) {
  if src == nil { panic("src is nil") }
  if dest == nil { panic("dest is nil") }
  self.insn5("movs", self.typeSuffix2(src.GetTypeId(), dest.GetTypeId()), src, dest)
}

func (self *AssemblyCode) movzx(src *amd64.Register, dest *amd64.Register) {
  if src == nil { panic("src is nil") }
  if dest == nil { panic("dest is nil") }
  self.insn5("movz", self.typeSuffix2(src.GetTypeId(), dest.GetTypeId()), src, dest)
}

func (self *AssemblyCode) movzb(src *amd64.Register, dest *amd64.Register) {
  if src == nil { panic("src is nil") }
  if dest == nil { panic("dest is nil") }
  self.insn5("movz", "b"+self.typeSuffix(dest.GetTypeId()), src, dest)
}

func (self *AssemblyCode) lea(src xtc_core.IOperand, dest *amd64.Register) {
  if src == nil { panic("src is nil") }
  if dest == nil { panic("dest is nil") }
  self.insn6(self.NaturalType, "lea", src, dest)
}

func (self *AssemblyCode) neg(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn4(reg.GetTypeId(), "neg", reg)
}

func (self *AssemblyCode) add(diff xtc_core.IOperand, base *amd64.Register) {
  if diff == nil { panic("diff is nil") }
  if base == nil { panic("base is nil") }
  self.insn6(base.GetTypeId(), "add", diff, base)
}

func (self *AssemblyCode) sub(diff xtc_core.IOperand, base *amd64.Register) {
  if diff == nil { panic("diff is nil") }
  if base == nil { panic("base is nil") }
  self.insn6(base.GetTypeId(), "sub", diff, base)
}

func (self *AssemblyCode) imul(m xtc_core.IOperand, base *amd64.Register) {
...
func (self *AssemblyCode) div(base *amd64.Register) {
  if base == nil { panic("base is nil") }
  self.insn4(base.GetTypeId(), "div", base)
}

func (self *AssemblyCode) idiv(base *amd64.Register) {
  if base == nil { panic("base is nil") }
  self.insn4(base.GetTypeId(), "idiv", base)
}

func (self *AssemblyCode) not(reg *amd64.Register) {
  if reg == nil { panic("reg is nil") }
  self.insn4(reg.GetTypeId(), "not", reg)
}

func (self *AssemblyCode) and(bits xtc_core.IOperand, base *amd64.Register) {
  if bits == nil { panic("bits is nil") }
  if base == nil { panic("base is nil") }
  self.insn6(base.GetTypeId(), "and", bits, base)
}

func (self *AssemblyCode) or(bits xtc_core.IOperand, base *amd64.Register) {
  if bits == nil { panic("bits is nil") }
  if base == nil { panic("base is nil") }
  self.insn6(base.GetTypeId(), "or", bits, base)
}

func (self *AssemblyCode) xor(bits xtc_core.IOperand, base *amd64.Register) {
  if bits == nil { panic("bits is nil") }
  if base == nil { panic("base is nil") }
  self.insn6(base.GetTypeId(), "xor", bits, base)
}

func (self *AssemblyCode) sar(bits *amd64.Register, base *amd64.Register) {
  if bits == nil { panic("bits is nil") }
  if base == nil { panic("base is nil") }
  self.insn6(base.GetTypeId(), "sar", bits, base)
}

func (self *AssemblyCode) sal(bits *amd64.Register, base *amd64.Register) {
  if bits == nil { panic("bits is nil") }
  if base == nil { panic("base is nil") }
  self.insn6(base.GetTypeId(), "sal", bits, base)
}

func (self *AssemblyCode) shr(bits *amd64.Register, base *amd64.Register) {
  if bits == nil { panic("bits is nil") }
  if base == nil { panic("base is nil") }
